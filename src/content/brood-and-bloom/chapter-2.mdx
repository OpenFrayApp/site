...
- **Lector.** Runs a house. Every lector served as a prosector first. Lectors diagnose,
  teach, and decide who is admitted.
...
safe to cast on any case, and on a chantry case a restoration spell is a meal. Rank follows the career. Every lector served as a prosector first, which is why the
officer running a house is the strongest the order fields.
