...
Leave the laptop at home, or keep your hands on its keyboard. OpenFray 1.1 gives
phones and tablets their own layouts and lets you advance turns, apply effects,
and cast spells with shortcuts you can change.
...
caster, so you can see what remains after resolving the attack.
...
## Keep the next session’s hooks with the campaign
