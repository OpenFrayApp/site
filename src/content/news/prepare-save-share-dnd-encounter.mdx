...
A list of creatures in one note, the party in another, and a browser full of stat
blocks: that is a lot to reopen on game night.
...
The label is an estimate. A saved character can carry their class, level, and
...
Use the estimate to spot a mismatch while you can still change the encounter.
...
the tracker and give it a name you will recognize, such as “The Ogre at Vaelthorn Bridge.”
...
A save holds the creatures, party, hit points, effects, conditions, initiative,
current round, and log as they stand. You can save the prepared encounter or stop
during round 6 and resume there next week.
...
Publishing needs an account. Under **Shared links**, you can copy a published link
again or unpublish it.
