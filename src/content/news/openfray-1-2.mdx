...
**Save** keeps the board as it stands: creatures, party, hit points, effects,
conditions, initiative, the current round, and the log.

You can also build the fight on Tuesday and have it waiting on Saturday with the
cast already assembled. Save as many encounters as you want, as often as you want.
...
Show the **campaign’s name and your Game Master name** above the board. Each has
its own setting under Player view. Both start off and require a signed-in GM.
...
- Player-view links now use `openfray.app/p/`; published encounters use
  `openfray.app/s/`.
...
- Tap or point at the **?** beside a field’s label to read its description.
