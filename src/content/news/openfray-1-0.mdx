...
Share a link to the player view. It shows the turn order and game log, updating as
you run the fight. You choose what reaches it:
...
The [player-view guide](/docs/guides/player-view/) covers the sharing controls.

## Apply the whole effect together

An effect with a condition, a modifier, and a reminder can now be applied as one
named bundle. Stage it in **Apply effect**; the parts log as one entry and clear together.
...
- **Exhaustion has a level** and can be applied through an attack or a saving throw.
...
behind the total. An arrow separates the dice from their total, and a natural 1 is
labeled a critical miss. There is a reroll wherever OpenFray rolls.
...
and 11 spells you can cast from the console. Intoxication, Craving, and Addiction
are available as effect presets.
...
[Open the console](/console/), add your party, and share the player-view link.
Sign in with Google or Discord to save your characters and campaigns.
