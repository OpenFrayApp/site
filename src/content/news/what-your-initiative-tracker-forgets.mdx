...
I wanted a DnD combat tracker to remember that for me. [OpenFray](/console/) does.
...
Remembering an effect for one roll was only part of the problem. We also let spells run
for an extra round or removed them too soon.
...
A player can still catch something I forgot to put on the board. Once it is there, they no
longer have to remind me every round. They can think about their next turn while I run the
Ogre's.
